...
export function resetMockDb() {
  ...
  mockDb.user_profiles = [...mockUserProfiles];
  mockDb.components = [...mockComponents];
  mockDb.palletizer_specs = [...mockPalletizerSpecs];
  mockDb.conveyor_specs = [...mockConveyorSpecs];
  mockDb.manipulator_specs = [...mockManipulatorSpecs];
  mockDb.wrapper_specs = [...mockWrapperSpecs];
  mockDb.turn_unit_specs = [...mockTurnUnitSpecs];
  mockDb.pallet_dispenser_specs = [...mockPalletDispenserSpecs];
  mockDb.sheet_dispenser_specs = [...mockSheetDispenserSpecs];
  mockDb.end_of_line_specs = [...mockEndOfLineSpecs];
  mockDb.collar_specs = [...mockCollarSpecs];
  mockDb.main_frame_specs = [...mockMainFrameSpecs];
  mockDb.conveyor_accessories = [...mockConveyorAccessories];
  mockDb.main_frame_configurations = [...mockMainFrameConfigurations];
  mockDb.turn_unit_configurations = [...mockTurnUnitConfigurations];
  mockDb.wrapper_configurations = [...mockWrapperConfigurations];
  mockDb.infeed_coupling_compatibility = [...mockInfeedCouplingCompatibility];
  ...
  mockDb.product_types = [...mockProductTypes];
  mockDb.transport_types = [...mockTransportTypes];
  mockDb.translations = [...mockTranslations];
